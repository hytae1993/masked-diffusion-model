...
time=""
method="base"
title="3_mask-base_sample-log_time_10-weight_loss_20-independent_lr_1e-4_metface"
# ==============================
model=default
batch_size=128
in_channel=3
...
loss_weight_power_base=20.0
loss_space="x_0"
ddpm_num_steps=1024
ddpm_schedule="log_scale"
ddpm_schedule_base=10.0
