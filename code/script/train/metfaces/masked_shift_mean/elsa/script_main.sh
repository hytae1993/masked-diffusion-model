...
time=""
method="mean_shift"
title="20000epoch-attention_1-momentum_dependent_sample-sigmoid_base_0.1_time-base_loss-lr_3e-4-degrade_image_wise-metface_N128"
# ==============================
model=default
batch_size=32
in_channel=3
...
loss_weight_power_base=10000.0
loss_space="x_0"
ddpm_num_steps=4096
ddpm_schedule="sigmoid"
ddpm_schedule_base=0.1
