...
time=""
method="mean_shift"
title="momentum_dependent_sample-sigmoid_base_1.5_time-base_loss-lr_3e-4-degrade_image_wise-metface_N128"
# ==============================
model=default
batch_size=32
in_channel=3
...
loss_weight_power_base=400.0
loss_space="x_0"
ddpm_num_steps=4096
ddpm_schedule="sigmoid"
ddpm_schedule_base=1.5
