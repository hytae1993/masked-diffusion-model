...
title="mean-shift-train_base-momentum-sampling_4096-steps_2048_data"
# ==============================
model=default
batch_size=32
in_channel=3
...
# ========== for test ==========
test_model_path="/nas/users/hyuntae/code/doctor/masked-diffusion-model/result/code_progress/celeba_hq/mean_shift/2024_04_17_12_32_56/2048_momentum_4096-step_log-base_loss-lr_3e-4-degrade_image_wise-celeba_hq/checkpoint/checkpoint-epoch-9999"
...
do 
    ...
    accelerate launch --config_file '/nas/users/hyuntae/code/doctor/masked-diffusion-model/code/script/train/config/gpu2_config.yaml' ${code} \
        --use_wandb=${use_wandb} \
