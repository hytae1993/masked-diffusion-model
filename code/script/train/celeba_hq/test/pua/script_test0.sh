...
method="test"
test_method="base"
title="base-train_boosting-sampling_4096-steps_2048_data"
# ==============================
model=default
batch_size=32
in_channel=3
...
# ========== for test ==========
test_model_path="/nas/users/hyuntae/code/doctor/masked-diffusion-model/result/code_progress/celeba_hq/base/2024_03_08_13_00_21/2048_data-50000_epoch-attention_1-momentum_dependent_sample-4096_step_log-base_loss-lr_3e-4-degrade_image_wise-celeba_hq/checkpoint/checkpoint-epoch-10000"
